...
#                 self._log.info(
#                     " " * 5 + "*" * 14 + " " * 15 + f"{tag} : {str(value)[0:100]}"
#                 )  # only take first 100 characters of value to prevent bad output to screen
...
#         self, span_validator, matching_tags=False, required_tags=False, optional_tags=False, no_tags_to_assert=False
#     ):
#         phrase = ""
#         if matching_tags:
